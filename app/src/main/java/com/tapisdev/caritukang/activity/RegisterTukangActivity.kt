...
import com.tapisdev.caritukang.activity.admin.SelectMapsActivity
...
class RegisterTukangActivity : BaseActivity() ,PermissionHelper.PermissionListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnLokasiReg.setOnClickListener {
            val i = Intent(this, SelectMapsActivity::class.java)
            startActivity(i)
        }
        btnSimpanTukangReg.setOnClickListener {
            checkValidation()
        }
        rlImageTukangReg.setOnClickListener {
            launchGallery()
        }
        ...
        spKategoriReg.adapter = adapterSpinnerKategori
        spKategoriReg.setOnItemSelectedListener(object : AdapterView.OnItemSelectedListener {
    ...
    fun checkValidation(){
        var getName = edNamaTukangReg.text.toString()
        var getPhone = edPhoneTukangReg.text.toString()
        var getAlamat = edAlamatTukangReg.text.toString()
        var getjamkerja = edJamKerjaReg.text.toString()
    ...
    fun saveData(){
        ...
        tukangRef.document().set(tukang).addOnCompleteListener {
            ...
            if (task.isSuccessful){
                ...
                dismissLoading()
                showLongSuccessMessage("Permintaan Daftar Tukang Berhasil, silahkan tunggu admin memverifikasi data anda")
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == Activity.RESULT_OK) {
            ...
            try {
                ...
                fotoBitmap = bitmap
                imageTukangReg.setImageBitmap(bitmap)
                textSelectImageTukangReg.visibility = View.GONE
            } catch (e: IOException) {
                e.printStackTrace()
            }
        }
    ...
    override fun onResume() {
        ...
        if (SharedVariable.centerLatLon.latitude != 0.0){
            ...
            val img: Drawable = btnLokasiReg.context.resources.getDrawable(R.drawable.ic_check_black_24dp)
            btnLokasiReg.setText("Lokasi Telah dipilih")
            btnLokasiReg.setCompoundDrawables(img,null,null,null)
